...
2. **Custom Macros**
   Reusable business logic for categorization, math operations, and string utilities.

3. **Dynamic SQL Generation**
   Jinja loops for maintainable joins in the `OBT` (One Big Table) model.
...
* Snowflake Account (will create one if doesn't exist)
* Python Environment: Python 3.12 or higher, pip or uv package manager
* **AWS Account** (for S3 storage)
